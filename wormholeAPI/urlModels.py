...
from resourceIDs import WH_CASE_IDS
...
class CallUrl:
    ...
    def _applyResponse(self):
        ...
        self.isSuccess = int(self.res_dict['isSuccess'])
...
class ThumbNailUpload:
    def __init__(self,  corpPrefix = None,projectId=None,nodeType=None):
        self.filename = ''
        self.corpPrefix_value = corpPrefix
        self.projectId = projectId
        self.dirType = nodeType
        if USE_URL_CUSTOM[0]:
            self.rnt_query = 'http://%s/interface/upload_thumbnail.php?corpPrefix=%s&projectId=%s&nodeType=%s' % (
                                            USE_URL_CUSTOM[1],
                                            self.corpPrefix_value,
                                            self.projectId,
                                            self.dirType)
            ...
            self.rnt_query = 'http://%s%supload_thumbnail.php?corpPrefix=%s&projectId=%s&nodeType=%s' % (
                                            self.corpPrefix_value,
                                            URL_ROOT,
                                            self.corpPrefix_value,
                                            self.projectId,
